    ...
    <div class="wrapper">
        ...
        <?php 
             if(isset($_GET['id']))
            {
                ...
                {
                    header('location:'.SITEURL.'Yonetici_islemleri/p_siparis.php');
                }
            }
            else
            {
                ...
                <tr>
                    <td clospan="2">
                        ...
                        <input type="submit" name="submit" value="Siparis Guncell" class="btn-secondary">
                         <button class="btn-secondary"><a href="p_siparis.php" class="btn-secondary" > Iptal </a</button>
                    </td>
                </tr>
            </table>
