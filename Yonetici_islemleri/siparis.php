...
<div class="main-content">
    <div class="wrapper">
        <h1>Yemek Siparisini Yonet</h1>

                <br /><br />
                 <a href="tumsatis.php?id=2" class="btn-secondary" style=" background-color:#00CCCC"> TUM SATISLAR YAZDIR </a><br /><br /><br />
                            ...
                            while($row=mysqli_fetch_assoc($res))
                            {
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo SITEURL; ?>Yonetici_islemleri/siparis_goster.php?id=<?php echo $id; ?>" class="btn-secondary">DETAY</a>
                                        </td>
